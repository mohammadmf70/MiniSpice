...
Q_CONSTINIT const QMetaObject CapacitorComponent::staticMetaObject = { {
    ...
    >,
=======
struct qt_meta_tag_ZN18CapacitorComponentE_t {};
} // unnamed namespace

template <> constexpr inline auto CapacitorComponent::qt_create_metaobjectdata<qt_meta_tag_ZN18CapacitorComponentE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<CapacitorComponent, qt_meta_tag_ZN18CapacitorComponentE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject CapacitorComponent::staticMetaObject = { {
    QMetaObject::SuperData::link<GraphicComponent::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18CapacitorComponentE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18CapacitorComponentE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN18CapacitorComponentE_t>.metaTypes,
>>>>>>> e075db8 (Initial commit to Mmfotuhi branch)
    nullptr
} };
...
<<<<<<< HEAD
    ...
    (void)_c;
=======
    auto *_t = static_cast<CapacitorComponent *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
>>>>>>> e075db8 (Initial commit to Mmfotuhi branch)
...
=======
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN18CapacitorComponentE_t>.strings))
>>>>>>> e075db8 (Initial commit to Mmfotuhi branch)
